/*! algoliasearch 3.24.9 | © 2014, 2015 Algolia SAS | github.com/algolia/algoliasearch-client-js */ ! function(e) {
    var t;
...
function e(t, r, o) {
    ...
    2: [function(e, t, r) {
        ...
        function i(e) {
            ...
            for (var t = ("string" == typeof e ? e : "").split(/[\s,]+/), o = t.length, n = 0; n < o; n++) t[n] && (e = t[n].replace(/\*/g, ".*?"), "-" === e[0] ? r.skips.push(new RegExp("^" + e.substr(1) + "$")) : r.names.push(new RegExp("^" + e + "$")))
        }
    ...
    3: [function(e, t, r) {
        (function(o, n) {
            ! function(e, o) {
                "object" == typeof r && "undefined" != typeof t ? t.exports = o() : "function" == typeof define && define.amd ? define(o) : e.ES6Promise = o()
            }(this, function() {
                "use strict";
                ...
                function U(e, t, o, n) {
                    var i = r(o),
                        ...
                        u = void 0;
                    if (i) {
                        if (s = E(o, n), s === ue ? (u = !0, a = s.error, s.error = null) : c = !0, t === s) return void S(t, g())
                    } else s = n, c = !0;
                    t._state !== ie || (i && c ? j(t, s) : u ? S(t, a) : e === se ? A(t, s) : e === ae && S(t, s))
                }
                ...
                var $ = Q,
                    ...
                    re = new Array(1e3),
                    oe = void 0;
                oe = ee ? a() : Z ? u() : te ? l() : void 0 === Y && "function" == typeof e ? h() : p();
                ...
                }, F.all = L, F.race = K, F.resolve = y, F.reject = H, F._setScheduler = i, F._setAsap = s, F._asap = W, F.prototype = {
                    constructor: F,
                    then: f,
                    "catch": function(e) {
    ...
    4: [function(e, t, r) {
        ...
        t.exports = o, o.EventEmitter = o, o.prototype._events = void 0, o.prototype._maxListeners = void 0, o.defaultMaxListeners = 10, o.prototype.setMaxListeners = function(e) {
            ...
            if (n(r)) switch (arguments.length) {
                ...
                for (i = Array.prototype.slice.call(arguments, 1), u = r.slice(), o = u.length, c = 0; c < o; c++) u[c].apply(this, i);
            return !0
            ...
            if (r = this._events[e], i = r.length, o = -1, r === t || n(r.listener) && r.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);
            else if (s(r)) {
                for (a = i; a-- > 0;)
    ...
    10: [function(e, t, r) {
        ...
        var o = Object.prototype.hasOwnProperty,
            ...
            y = function(e) {
                ...
                if (c)
                    for (var v = f(e), g = 0; g < l.length; ++g) v && "constructor" === l[g] || !o.call(e, l[g]) || p.push(l[g]);
                return p
            };
        y.shim = function() {
            if (Object.keys) {
    ...
    15: [function(e, t, r) {
        (function(r) {
            function o(t, r, o) {
                ...
                if (this._checkAppIdData(), o.hosts) a(o.hosts) ? (this.hosts.read = s(o.hosts), this.hosts.write = s(o.hosts)) : (this.hosts.read = s(o.hosts.read), this.hosts.write = s(o.hosts.write));
                    ...
                    var d = u(this._shuffleResult, function(e) {
                        return "search.shajgoj.com"
                    });
                    this.hosts.read = ["search.shajgoj.com"].concat(d), this.hosts.write = ["search.shajgoj.com"].concat(d)
                }
            ...
            o.prototype.initIndex = function(e) {
                ...
                function r(e, u) {
                    ...
                    function g(e) {
                        ...
                        return v.push({
                            ...
                            endTime: r,
                            duration: r - x
                        }), e instanceof c.AlgoliaSearchError || (e = new c.Unknown(e && e.message, e)), f += 1, e instanceof c.Unknown || e instanceof c.UnparsableJSON || f >= h.hosts[t.hostType].length && (y || !m) ? (e.debugData = v, h._promise.reject(e)) : e instanceof c.RequestTimeout ? b() : w()
                    }
                ...
                var o, n, s = e(1)("algoliasearch:" + t.url),
                    l = t.additionalUA || "",
                    p = t.cache,
                    h = this,
                    f = 0,
    ...
    16: [function(e, t, r) {
        ...
        t.exports = o, i(o, s), o.prototype.addObject = function(e, t, r) {
            ...
            return n(this.searchSynonyms, e, t)
    ...
    19: [function(e, t, r) {
        (function(t) {
            ...
            var n = e(7),
                ...
                c = e(24),
                u = e(34);
            window.algoliasearch = e(20), "debug" === t.env.NODE_ENV && e(1).enable("algoliasearch*"), r.version = e(36), r.ua = "Algolia for jQuery " + r.version, r.initPlaces = u(r), window.__algolia = {
                debug: e(1),
                algoliasearch: r
            };
            var l = window.jQuery;
            l.algolia = {
                ...
                ua: r.ua,
                version: r.version
            }, n(o, i), o.prototype._request = function(e, t) {
                return new l.Deferred(function(r) {
                    var o = t.body;
                    e = a(e, t.headers);
                    var n = {
                        accept: "application/json"
                    };
                    o && ("POST" === t.method ? n["content-type"] = "application/x-www-form-urlencoded" : n["content-type"] = "application/json"), l.ajax(e, {
                        type: t.method,
                        timeout: t.timeouts.complete,
                        dataType: "json",
                        data: o,
                        headers: n,
                        complete: function(e, t) {
                            return "timeout" === t ? void r.reject(new s.RequestTimeout) : 0 === e.status ? void r.reject(new s.Network({
                                more: e
                            })) : void r.resolve({
                                statusCode: e.status,
                                body: e.responseJSON,
                ...
                return e = a(e, t.headers), new l.Deferred(function(r) {
                    c(e, t, function(e, t) {
                        return e ? void r.reject(e) : void r.resolve(t)
                    })
                }).promise()
            }, o.prototype._promise = {
                reject: function(e) {
                    return new l.Deferred(function(t) {
                        t.reject(e)
                    }).promise()
                },
                resolve: function(e) {
        ...
        (function(r) {
            ...
            t.exports = function(t, i) {
                function s(t, r, o) {
                    var n = e(26),
                        i = e(22);
                    return o = n(o || {}), void 0 === o.protocol && (o.protocol = i()), o._ua = o._ua || s.ua, new a(t, r, o)
                }
                ...
                var c = e(7),
                    ...
                    p = e(24),
                    d = e(34);
                i = i || "", "debug" === r.env.NODE_ENV && e(1).enable("algoliasearch*"), s.version = e(36), s.ua = "Algolia for vanilla JavaScript " + i + s.version, s.initPlaces = d(s), o.__algolia = {
                    debug: e(1),
                    algoliasearch: s
                };
                var h = {
    ...
    34: [function(e, t, r) {
        function o(t) {
            return function(r, o, i) {
                var s = e(26);
                i = i && s(i) || {}, i.hosts = i.hosts || ["search.shajgoj.com"], 0 !== arguments.length && "object" != typeof r && void 0 !== r || (r = "", o = "", i._allowEmptyCredentials = !0);
                var a = t(r, o, i),
