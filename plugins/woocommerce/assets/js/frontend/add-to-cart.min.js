jQuery(function(e) {
    ...
    t.prototype.onAddToCart = function(t) {
        ...
        if (a.is(".ajax_add_to_cart")) {
            if (!a.attr("data-product_id") && !a.parent().find("input.variation_id").length) return !0;
            if (a.parent().find("input.variation_id").length) {
                a.removeData("product_id");
                a.attr("data-product_id", a.parent().find("input.variation_id").val());
                a.data("product_id", a.parent().find("input.variation_id").val());
            };
