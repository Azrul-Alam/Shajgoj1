...
(function(root, factory) {
    ...
    var SmartBanner = function(options) {
        ...
        if (this.options.force) {
            ...
            if (UA.match(/Safari/i) !== null && (UA.match(/CriOS/i) !== null || UA.match(/FxiOS/i) != null || window.Number(UA.substr(UA.indexOf('OS ') + 3, 3).replace('_', '.')) < 6)) {
                this.type = 'ios';
            }
    ...
    SmartBanner.prototype = {
        ...
        create: function() {
            ...
            var banner = ('<div id="smartbanner" class="' + this.type + '">' +
...
jQuery(function() {
    jQuery.smartbanner({
        ...
        inWindowsStore: 'In the Windows Store',
        GooglePlayParams: null,
        icon: 'https://shop.shajgoj.com/wp-content/uploads/2022/01/app-icon-rounded.png',
        iconGloss: null,
        url: null,
        button: 'INSTALL',
        scale: 'auto',
